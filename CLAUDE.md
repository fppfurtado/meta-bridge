...
- `docs/decisions/ADR-001-skills-de-bridge.md` — mechanical ADR (16 sub-decisions covering skill internals; SD11 adicionada em v0.9.0 cobrindo `/wiki-compile` per Onda 2; SD12 (2026-06-20) cobrindo `/enrich-blocks` + hook dispatcher; SD13 (2026-06-23) cobrindo `/source-digest` + hook notifier; SD14 (2026-06-23) contrato `#inbox` de reconciliação; SD15 (2026-06-24) `/journal-review` heurística 8 phantom-tag; SD16 (2026-06-25) cobrindo `/wiki-lint` Onda 6 Camada 4).
